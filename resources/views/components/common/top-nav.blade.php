        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{url('/')}}/assets/images/favicon.ico" alt="{{ config('app.name') }}" height="42">
                    </span>
                    <span class="logo-lg">
                        <img src="{{url('/')}}/assets/images/favicon.ico" alt="{{ config('app.name') }}" height="42"> <span class="logo-txt">{{ config('app.name') }}</span>
                    </span>
                </a>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <img src="{{url('/')}}/assets/images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
