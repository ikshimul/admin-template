            ...
            <div class="d-flex flex-column h-100">
                <div class="mb-4 mb-md-5 text-center">
                    <a href="#" class="d-block auth-logo">
                        <img src="{{url('/')}}/assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">{{ config('app.name') }}</span>
                    </a>
                </div>
                <!-- <div class="mb-2 mb-md-5 text-center">
                    <a href="" class="d-block auth-logo">
                        <img
                            src="{{url('/')}}/assets/images/logo-sm.svg" alt="{{ config('app.name') }}" height="66">
                ...
                <div class="auth-content my-auto">
                    ...
                    @endif
                    <form class="mt-2 pt-2 needs-validation" method="POST" action="{{ route('login') }}">
                        @csrf
                        <div class="mb-3 @error('email') has-danger @enderror">
                            <label for="email" class="form-label">{{ __('Email address') }}</label>
                            <x-input id="email" class="" type="email" name="email" :value="old('email')" placeholder="{{ __('Enter email address') }}" required autofocus autocomplete="username" />
                            @error('email')
